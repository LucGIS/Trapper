...
urlpatterns = patterns('',
	...
	url(r'resource/update/(?P<pk>\d+)/$', UpdateView.as_view(model=Resource), name='resource_update'),
	...
	url(r'resourcecollection/update/(?P<pk>\d+)/$', UpdateView.as_view(model=ResourceCollection), name='collection_update'),
	url(r'resourcecollection/create/$', CreateView.as_view(model=ResourceCollection), name='collection_create'),
